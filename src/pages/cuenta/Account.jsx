            ...
            <section className="account">
                ...
                <div className="account-profile">
                    ...
                    <article className="account-info">
                        <h2 className="account-name">Mariana Portella</h2>
                        {/* INFORMACION */}
                        <ul className="account-data">
                            <li className="account-data-personal">Argentina</li>
                            <li className="account-data-personal">12 Torneos</li>
                            <li className="account-data-personal">73 Amigos</li>
                        </ul>
                        {/* REDES SOCIALES */}
                        <ul className="account-social">
                            <li className="account-social-li">
                                <a className="account-social-icon" href="#">
