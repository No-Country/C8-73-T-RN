...
const CategoriesGames = () => {
    ...
    return (
        ...
        <div>
            ...
            <div className="header-category-container">
                <h3><span><i className="game-category-ico">{gamepadIco}</i></span>Torneos próximos a iniciar</h3>  
                <p>Ver todos <span><i className="game-category-ico">{arrowIco}</i></span></p>                
            </div>
            ...
            <div className="header-category-container">
                <h3><span><i className="game-category-ico">{gamepadIco}</i></span>Los mejores torneos</h3>  
                <p>Ver todos <span><i className="game-category-ico">{arrowIco}</i></span></p>                
            </div>
